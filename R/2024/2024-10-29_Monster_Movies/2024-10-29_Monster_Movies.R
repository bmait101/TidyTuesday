...
cap <- "Data: IMDb | Visualisation: Bryan Maitland, with help from @nrennie35"
...
ggsave(
  file.path("R", "2024", "2024-10-29_Monster_Movies", paste0("p1_documentaries_best", ".png")),
  bg = bg_col,
  width = 4,
  height = 5.5
)
